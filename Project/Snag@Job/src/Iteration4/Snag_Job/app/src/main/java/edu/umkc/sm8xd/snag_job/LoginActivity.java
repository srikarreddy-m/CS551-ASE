...
public class LoginActivity extends PlusBaseActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //   session.createLoginSession(txtUsername.toString(),txtUsername.toString());
        //    System.out.print("Sessions details are:" + session.getUserDetails());
...
//                Intent i = new Intent(getApplicationContext(), GmailLoginActivity.class);
//                startActivity(i);
//
//            }
//        });
      //  below is the default code for gmail signin
        if (supportsGooglePlayServices()) {
            ...
            mPlusSignInButton.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    intent1.putExtra("user_email", txtUsername.getText().toString());
...
//                session.createLoginSession(loginEmail.toString(),loginpwd.toString());
//                System.out.print("Sessions details are:"+session.getUserDetails().get("name"));
//                Toast.makeText(getApplicationContext(), "User Login Status: " + session.isLoggedIn(), Toast.LENGTH_LONG).show();
            }
            // attemptLogin();
        ...
        Button signin_LinkedIn_Button = (Button) findViewById(R.id.login_linkedIn_button);
        signin_LinkedIn_Button.setOnClickListener(new OnClickListener() {
            @Override

            public void onClick(View arg0) {
            Intent linkedInintent = new Intent(context, LinkedInSampleActivity.class);
    ...
    private class ReadWCFServiceFeed extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            try {
                ...
                System.out.println("Json result for email" + jsonObject.getString("email"));
                System.out.println("from text box" + txtUsername.getText().toString());

                if (jsonObject.getString("email").equals(txtUsername.getText().toString()) && jsonObject.getString("password").equals(txtPassword.getText().toString())) {

                    setDefaults("user_email", txtUsername.getText().toString(),context);
                    Intent intent1 = new Intent(context, SignInActivity.class);
                    intent1.putExtra("user_email", txtUsername.getText().toString());
