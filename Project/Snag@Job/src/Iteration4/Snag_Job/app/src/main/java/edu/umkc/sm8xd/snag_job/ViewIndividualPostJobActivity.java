            ...
            if (isViewApplication) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonarray.length(); i++) {
                        ...
                        g_result.add(jsonobject_application.getString("JobID")+ "\t" + "\t" + "\t" + "\t" +jsonobject_application.getString("Email") + "\t" + "\t" + "\t" + "\t" + jsonobject_application.getString("TestScore"));
                        ...
                        System.out.println("Test Score::" + jsonobject_application.getString("TestScore"));
